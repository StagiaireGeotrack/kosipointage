...
<x-app-layout>
                                            ...
                                            @if (auth()->id() !== $admin->ID )
                                                ...
                                                @if($admin->deleted)
                                                    <button type="button" class="btn btn-link text-danger p-0 border-0" 
                                                        onclick="setResetAction('{{ route('administrateurs.reset', $admin->ID) }}', '{{ $admin->Identifiant_email }}')" 
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-link text-danger p-0 border-0" 
                                                        onclick="setDeleteAction('{{ route('administrateurs.destroy', $admin->ID) }}', '{{ $admin->Identifiant_email }}')" 
                                                        data-bs-toggle="modal" 
                ...
                <div class="modal fade" id="resetModal" tabindex="-1" aria-labelledby="resetModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>{{ __('Voulez-vous vraiment réinitialiser cet administrateur ?') }}</p>
                                <p class="fw-bold" id="admin_"></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('Annuler') }}</button>
    ...
    @push("scripts")
        ...
        function setResetAction(url, name) {
            ...
            document.getElementById('admin_').textContent = name;
        }
