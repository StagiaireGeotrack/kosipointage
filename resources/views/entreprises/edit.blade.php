        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ __('Modifier l\'entreprise') }}</h5>
                            ...
                            <div class="col-md-4">
                                <div class="text-center mb-3">
                                    @if($entreprise->Logo)
                                        ...
                                        <p class="text-muted">{{ __('Logo actuel') }}</p>
                                    @else
                                        ...
                                        <p class="text-muted">{{ __('Pas de logo') }}</p>
                                    @endif
                                </div>
                                
                                <div class="form-group">
                                    <label for="Logo">{{ __('Changer le logo') }}</label>
