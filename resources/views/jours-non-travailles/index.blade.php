...
<x-app-layout>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex gap-2">
                                            ...
                                            $jour_details =  $jour->Nom . ' - ' . ucfirst($jour->Date->isoFormat('dddd D MMMM YYYY'));

                                            @endphp

                                            <button type="button" class="btn btn-link text-danger p-0 border-0" 
                                                    onclick="setDeleteAction('{{ route('jours-non-travailles.destroy', $jour->ID) }}', '{{ $jour_details }}')" 
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="fw-bold" id="details_jour"></p>
                            </div>
    ...
    @push("scripts")
        ...
        function setDeleteAction(url, name) {
            ...
            document.getElementById('details_jour').textContent = name;
        }
        </script>
