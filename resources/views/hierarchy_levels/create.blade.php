{{-- resources/views/hierarchy_levels/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <x-text-input id="code" name="code" type="text" class="form-control mt-1" 
                                :value="old('code')" placeholder="{{ __('Ex: N0, N1, N2...') }}" required />
                        ...
                        <div class="col-md-6">
                            ...
                            <x-text-input id="name" name="name" type="text" class="form-control mt-1" 
                                :value="old('name')" placeholder="{{ __('Ex: Employé / Opérationnel') }}" required />
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            ...
                            <x-text-input id="rank" name="rank" type="number" class="form-control mt-1" 
                                :value="old('rank')" placeholder="{{ __('Ex: 0, 1, 2...') }}" required min="0" />
                            ...
                            <div class="mt-2">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" role="switch" 
                                           ...
                                           {{ old('is_managerial') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_managerial">
                                        <span id="managerial_label">{{ old('is_managerial') ? 'Managerial' : 'Non managerial' }}</span>
                                    </label>
                                </div>
                            </div>
