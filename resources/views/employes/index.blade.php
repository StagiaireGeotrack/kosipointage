...
<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            @if (!auth()->user()->isSupervisor() && (auth()->user()->isTrueSuperAdmin() || auth()->user()->isSimpleAdmin()))
            ...
            <div class="card-body">
                ...
                <form action="{{ route('employes.index') }}" method="GET" class="mb-4">
                    <div class="row g-3 mb-3">
                        ...
                        {{-- Filtre Siège : masqué pour Supervisor --}}
                ...
                <!-- Exports : masqués pour Supervisor -->
                @if (!auth()->user()->isSupervisor())
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex gap-2">
                                            ...
                                            {{-- ✅ SUPERVISOR : uniquement le bouton "Voir" --}}
                                            @if (auth()->user()->isSupervisor())
                                            ...
                                            {{-- ✅ SUPER ADMIN / SIMPLE ADMIN / MASTER : tous les boutons --}}
                                            @elseif (auth()->user()->isTrueSuperAdmin() || auth()->user()->isSimpleAdmin())
