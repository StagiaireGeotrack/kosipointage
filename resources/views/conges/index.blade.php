...
<x-app-layout>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn btn-link text-danger p-0 border-0" 
                                                    onclick="setDeleteAction('{{ route('conges.destroy', $conge->id) }}', '')" 
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>{{ __('Voulez-vous vraiment supprimer ce congé ?') }}</p>
                                <p class="fw-bold" id="details_conge"></p>
                            </div>
    ...
    @push("scripts")
        ...
        function setDeleteAction(url, name) {
            ...
            document.getElementById('details_conge').textContent = name;
        }
        </script>
