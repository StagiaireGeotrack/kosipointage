            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('administrateurs.store') }}">
                        ...
                        <!-- Mot de passe -->
                        <div class="mb-3">
                            <x-input-label for="Password_" :value="__('app.password')" />
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label for="IsSuperAdmin" class="form-check-label">{{ __('app.is_super_admin') }}</label>
                            </div>
                            <small class="form-text text-muted">{{ __('app.super_admin_help') }}</small>
