{{-- resources/views/supervisors/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                ...
                <form method="POST" action="{{ route('supervisors.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <x-text-input id="Identifiant_email" class="form-control mt-1" type="email"
                            name="Identifiant_email" :value="old('Identifiant_email')" required />
                        ...
                        <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                            ...
                            @empty
                                <p class="text-muted mb-0">
                                    ...
                                    {{ __('Aucun service disponible pour votre entreprise. Créez d\'abord des services dans « Organisation → Services ».') }}
                                </p>
                            @endforelse
                        </div>
