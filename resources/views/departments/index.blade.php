                        ...
                        <tbody>
                            @forelse ($departments as $dept)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        {{ $dept->managerEmployee->Nom ?? '-' }}
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="badge bg-info">{{ $dept->employes->count() }}</span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex gap-2">
                                            ...
                                            <!-- Bouton Supprimer -->
                                            @if(!$dept->trashed() && $dept->employes->count() == 0)
                                            ...
                                            @elseif($dept->trashed())
                                                ...
                                                <button type="button" class="btn btn-link text-success p-0 border-0" 
                                                        onclick="if(confirm('Voulez-vous vraiment restaurer ce service ?')) {
                                                            document.getElementById('restore-form-{{ $dept->id }}').submit();
                                                        }" title="Restaurer">
                                                    <svg class="bi" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            @else
                                                <span class="text-muted" title="Impossible de supprimer : des employés sont dans ce service">
                                                    <svg class="bi" width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                                    </svg>
                                                </span>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">{{ __('Aucun service pour le moment') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
