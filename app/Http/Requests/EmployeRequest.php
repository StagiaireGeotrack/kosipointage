...
class EmployeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // ✅ Non-SuperAdmin en CREATE : Nom + SiegeID + Pin (sans BadgeID)
        if (!Auth::user()->IsSuperAdmin && !$isUpdate) {
            return [
                'Nom'     => 'required|string|max:255',
    ...
    protected function prepareForValidation(): void
    {
        ...
        // ✅ Ne préparer ces champs que pour CREATE ou SuperAdmin (inchangé)
        ...
        // ✅ AJOUT : Pour non-SuperAdmin aussi, convertir Pin vide en null
        if (!Auth::user()->IsSuperAdmin && $this->input('Pin') === '') {
            $this->merge(['Pin' => null]);
        }
    }
}